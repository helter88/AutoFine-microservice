...
public class KafkaTestConfig {
    ...
    @Bean
    public KafkaTemplate<String, MandateCreatedDto> mandateDataKafkaTemplate(ProducerFactory<String, MandateCreatedDto> producerFactory) {
        return new KafkaTemplate<>(producerFactory);
    }
    @Bean
    public ProducerFactory<String, MandateCreatedDto> mandateDataaProducerFactory() {
